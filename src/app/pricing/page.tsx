    ...
    <div style={{ backgroundColor: 'var(--bg-color)' }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase',
          backgroundColor: 'var(--primary-light)', color: 'var(--primary)',
          border: '1px solid rgba(59,130,246,0.15)', marginBottom: '1rem',
        }}>Pricing</span>
      ...
      <div style={{ padding: '4rem 1.5rem 5rem' }}>
        <div className="pricing-grid">
          ...
          <div style={planCardBase}>
            <p style={{ margin: '0 0 0.5rem', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>Free</p>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.75rem', paddingBottom: '1.75rem' }}>
              {['60 messages per month', '1 message variant per lead', 'Standard AI analysis', 'Email support'].map(f => (
                <li key={f} style={checkItemStyle}>{dot}{f}</li>
              ))}
            </ul>
            ...
            <Link href="/signup" style={{
              ...
              color: 'var(--text-main)', fontWeight: 600, fontSize: '0.9rem', boxShadow: 'var(--shadow-xs)',
            }}>
          ...
          <div style={{
            ...
            <p style={{ margin: '0.625rem 0 0.5rem', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'var(--primary)' }}>Starter</p>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem', marginBottom: '0.375rem' }}>
            ...
            <Link href="/login" style={{
              ...
              fontWeight: 600, fontSize: '0.9rem', boxShadow: '0 2px 8px rgba(59,130,246,0.3)',
              border: 'none',
            }}>
          ...
          {/* ── PRO ── */}
          <div style={planCardBase}>
            <p style={{ margin: '0 0 0.5rem', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>Pro</p>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem', marginBottom: '0.375rem' }}>
